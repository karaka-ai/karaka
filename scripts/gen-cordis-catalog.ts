...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  loaderBareModuleBaseUrl: 'not a service: boot-provided package-resolution base (string | undefined) for Loader trees — docs/architecture.md owns Karaka plugin resolution',
  ...
  connectionAuth: 'interface-typed credential verifier — packages/client/connection/README.md owns authentication',
  connectionCaller: 'per-invocation identity data, not a service — packages/client/connection/README.md owns authentication',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionWireEvent: 'session.md',
  ApplicationAgentRow: 'session.md',
  ApplicationChatCreate: 'session.md',
  ApplicationChatPrompt: 'session.md',
  ApplicationChatAddress: 'session.md',
  TypertAccessPolicy: 'typert.md',
