...
| `ctx.identity` | `seam` | [`identity`](../packages/identity/identity) | [`identity`](../packages/identity/identity) | [`identity`](../packages/identity/identity) | - | 一个包合并可信宿主规范化、严格 HTTP Bearer 解析和可选远程 JWKS 验证；资源授权仍是独立能力。 |
