...
Karaka has a separate publication boundary. `karaka start` resolves and launches `@karaka-ai/agent/bin`; the Agent package owns its composition and embedded plugin registry and does not resolve or launch the `dsh` package.
