...
| [persistence.md](persistence.md) | the durability seam: `SessionPersistence`, JSONL backend, `session/flush`, crash recovery, `SessionHeader` |
...
| [karaka-application.md](karaka-application.md) | application-server authentication, trusted chat ownership, and outbound MCP authorization |
