...
| [persistence.md](persistence.zh.md) | 持久性 seam：`SessionPersistence`、JSONL 后端、`session/flush`、崩溃恢复、`SessionHeader` |
...
| [karaka-application.md](karaka-application.zh.md) | 应用服务器认证、可信聊天 owner 与出站 MCP authorization |
