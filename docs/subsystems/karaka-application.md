...
See the [Karaka architecture](../architecture.md#karaka-application-runtime) for the complete process flow, [`@karaka/server-auth`](../../packages/karaka/server-auth/README.md) for credential providers, and [`@karaka/mcp-application`](../../packages/karaka/mcp-application/README.md) for application tool endpoints.
