...
完整进程流程见 [Karaka 架构](../architecture.zh.md#karaka-application-runtime)，凭据 provider 见 [`@karaka/server-auth`](../../packages/karaka/server-auth/README.zh.md)，应用工具 endpoint 见 [`@karaka/mcp-application`](../../packages/karaka/mcp-application/README.zh.md)。
