...
来源：[`packages/karaka/browser-auth/src/index.ts:24`](../packages/karaka/browser-auth/src/index.ts)

<a id="karaka-aiidentity"></a>

## `@karaka-ai/identity`

需要：`storage` · `sessions` · `sessionPersistence`
...
来源：[`packages/karaka/identity/src/index.ts:28`](../packages/karaka/identity/src/index.ts)
...
来源：[`packages/karaka/server-auth/src/index.ts:58`](../packages/karaka/server-auth/src/index.ts)
