...
```
<!-- END GENERATED config-catalog:@karaka-ai/browser-auth -->

<!-- BEGIN GENERATED config-catalog:@karaka-ai/identity -->
...
```
<!-- END GENERATED config-catalog:@karaka-ai/identity -->

<!-- BEGIN GENERATED config-catalog:@karaka-ai/mcp-application -->
...
```
<!-- END GENERATED config-catalog:@karaka-ai/mcp-application -->

<!-- BEGIN GENERATED config-catalog:@karaka-ai/server-auth -->
...
```
<!-- END GENERATED config-catalog:@karaka-ai/server-auth -->

<!-- BEGIN GENERATED config-catalog:@karaka-ai/transport-http -->
