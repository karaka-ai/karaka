...
Status: rejected — Karaka uses SQLite for durable application ownership and existing chats

English | [中文](2026-08-30-jsonl-only-session-persistence.zh.md)

## Problem

This upstream proposal applies to DSH profiles. Karaka selects SQLite in its production composition and retains existing schema-21 databases and their application owners; see the [Karaka runtime decision](../../implemented/architecture/2026-09-02-karaka-agent-runtime-package.md).
