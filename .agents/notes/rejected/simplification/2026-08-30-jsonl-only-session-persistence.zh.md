...
此上游提案适用于 DSH profile。Karaka 在生产组合中选择 SQLite，并保留现有 schema-21 数据库及其应用所有者；参见 [Karaka runtime 决策](../../implemented/architecture/2026-09-02-karaka-agent-runtime-package.zh.md)。
