...
The [optional CI credentials decision](2026-09-02-optional-ci-credentials.md) supersedes this note's requirement that trusted runs fail when `DEEPSEEK_API_KEY_EXTERNAL` is absent. The trigger and secret-exposure analysis below remains authoritative.
