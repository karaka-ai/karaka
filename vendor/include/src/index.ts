import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@karaka/cordis-plugin-loader'
 ...
 * offline config tooling parses and prints exactly the dialect this include
 * mounts.
 */
 ...
 * so rendered config can never drift from what boots. The input
