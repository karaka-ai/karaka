import { Context, Service, type Plugin } from '@karaka/cordis'
import type { Dict } from '@karaka/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@karaka/cordis-plugin-loader'
import type { Include } from '@karaka/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@karaka/cordis-plugin-timer'
import { fileURLToPath, pathToFileURL } from 'node:url'
import { createRequire } from 'node:module'
import picomatch from 'picomatch'
import z from '@karaka/schemastery'
...
namespace Hmr {
  ...
  // Karaka vendored modification: removed `.i18n({ 'en-US': enUS, 'zh-CN': zhCN })`
