...
import { ApplicationId, TenantId, UserId, SessionSeq } from '@deepseek-ai/dsh-session'
...
describe('serializeSessionLog', () => {
  ...
  it('preserves application ownership and lineage in the canonical physical header', () => {
