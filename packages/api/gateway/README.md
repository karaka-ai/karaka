...
- `websocketHeartbeatIntervalMs` sets the Ping cadence. The Host terminates a peer after two unanswered intervals and a deferred final check; deployments with longer event-loop or network stalls must increase this interval.
