...
Karaka is a persistent, multi-agent server for your application. Connect your backend or browser frontend to named agents, stream their responses, and let them call selected application functions as tools.
